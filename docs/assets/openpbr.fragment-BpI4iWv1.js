import{f as e}from"./math.scalar.functions-Cad0mLhT.js";import{t}from"./shaderStore-1xgJNigV.js";import"./clipPlaneFragmentDeclaration-BFq2Vl1Q.js";import"./logDepthDeclaration-wB0_714L.js";import"./fogFragmentDeclaration-BOK1x-R3.js";import"./logDepthFragment-DuqyoijQ.js";import"./fogFragment-CzjX75zo.js";import"./clipPlaneFragment-xWkUfbJz.js";import"./helperFunctions-Cx7K8ahf.js";import"./reflectionFunction-BA9GV8lK.js";import"./imageProcessingDeclaration-DEMU35fk.js";import"./lightFragmentDeclaration-BuWsyfR6.js";import"./lightUboDeclaration-CxdZlid9.js";import"./shadowsFragmentFunctions-DhgpAnMC.js";import"./imageProcessingFunctions-DWPRklFe.js";import"./pbrBRDFFunctions-bKdfDyxs.js";import"./harmonicsFunctions-DBXzlope.js";import"./oitFragment-Dv9fG0LG.js";import"./pbrDebug-xzbXWKbS.js";import"./samplerFragmentDeclaration-DncikHAx.js";import"./hdrFilteringFunctions-ClkvqT_M.js";import"./openpbrUboDeclaration-CQMqrJXo.js";import"./sceneFragmentDeclaration-sfN6AK_h.js";var n=`openpbrFragmentDeclaration`,r=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
#endif
`;t.IncludesShadersStore[c]||(t.IncludesShadersStore[c]=l);var u=`openpbrDielectricReflectance`,d=`struct ReflectanceParams
...
`;t.IncludesShadersStore[u]||(t.IncludesShadersStore[u]=d);var f=`openpbrConductorReflectance`,p=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;t.IncludesShadersStore[f]||(t.IncludesShadersStore[f]=p);var m=`openpbrAmbientOcclusionFunctions`,h=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;t.IncludesShadersStore[m]||(t.IncludesShadersStore[m]=h);var g=`openpbrGeometryInfo`,_=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var v=`openpbrIblFunctions`,y=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStore[v]||(t.IncludesShadersStore[v]=y);var b=`openpbrNormalMapFragment`,x=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;t.IncludesShadersStore[b]||(t.IncludesShadersStore[b]=x);var S=`openpbrBlockNormalFinal`,C=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStore[S]||(t.IncludesShadersStore[S]=C);var w=`openpbrBaseLayerData`,T=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStore[E]||(t.IncludesShadersStore[E]=D);var O=`openpbrCoatLayerData`,k=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStore[O]||(t.IncludesShadersStore[O]=k);var A=`openpbrThinFilmLayerData`,j=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStore[A]||(t.IncludesShadersStore[A]=j);var M=`openpbrFuzzLayerData`,N=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStore[M]||(t.IncludesShadersStore[M]=N);var P=`openpbrAmbientOcclusionData`,F=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;t.IncludesShadersStore[P]||(t.IncludesShadersStore[P]=F);var I=`openpbrBackgroundTransmission`,L=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStore[I]||(t.IncludesShadersStore[I]=L);var R=`openpbrEnvironmentLighting`,z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;t.IncludesShadersStore[R]||(t.IncludesShadersStore[R]=z);var B=`openpbrDirectLightingInit`,V=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[B]||(t.IncludesShadersStore[B]=V);var H=`openpbrDirectLighting`,U=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStore[H]||(t.IncludesShadersStore[H]=U);var W=e({openpbrPixelShader:()=>q}),G=`openpbrPixelShader`,K=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStore[G]||(t.ShadersStore[G]=K);var q={name:G,shader:K};export{W as t};