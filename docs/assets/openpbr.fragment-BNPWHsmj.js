import{f as e}from"./math.scalar.functions-Cad0mLhT.js";import{t}from"./shaderStore-1xgJNigV.js";import"./clipPlaneFragmentDeclaration-CK00Qt8q.js";import"./logDepthDeclaration-EqpAwMSr.js";import"./fogFragmentDeclaration-RvJpVjXC.js";import"./logDepthFragment-CV9WBFM8.js";import"./fogFragment-Dv8qZM1I.js";import"./clipPlaneFragment-CtiD5K0O.js";import"./helperFunctions-C0qxFmxM.js";import"./reflectionFunction-C4Q-EoYq.js";import"./imageProcessingDeclaration-Dbbfvl5W.js";import"./lightUboDeclaration-D9JTSI61.js";import"./shadowsFragmentFunctions-DyMSIgyx.js";import"./imageProcessingFunctions-JDRWgjJY.js";import"./pbrBRDFFunctions-B-9mK02Q.js";import"./harmonicsFunctions-BZv53ax0.js";import"./oitFragment-CPKfecR6.js";import"./pbrDebug-BBmwS8_C.js";import"./samplerFragmentDeclaration-DyuP4TNa.js";import"./hdrFilteringFunctions-7Ud6AaJf.js";import"./openpbrUboDeclaration-RR7TagSB.js";var n=`openpbrFragmentSamplersDeclaration`,r=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=`openpbrNormalMapFragmentMainFunctions`,a=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c=`openpbrDielectricReflectance`,l=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var u=`openpbrConductorReflectance`,d=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;t.IncludesShadersStoreWGSL[u]||(t.IncludesShadersStoreWGSL[u]=d);var f=`openpbrAmbientOcclusionFunctions`,p=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var m=`openpbrGeometryInfo`,h=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;t.IncludesShadersStoreWGSL[m]||(t.IncludesShadersStoreWGSL[m]=h);var g=`openpbrIblFunctions`,_=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;t.IncludesShadersStoreWGSL[g]||(t.IncludesShadersStoreWGSL[g]=_);var v=`openpbrNormalMapFragment`,y=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var b=`openpbrBlockNormalFinal`,x=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var S=`openpbrBaseLayerData`,C=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var E=`openpbrCoatLayerData`,D=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var O=`openpbrThinFilmLayerData`,k=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStoreWGSL[O]||(t.IncludesShadersStoreWGSL[O]=k);var A=`openpbrFuzzLayerData`,j=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var M=`openpbrAmbientOcclusionData`,N=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var P=`openpbrBackgroundTransmission`,F=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var I=`openpbrEnvironmentLighting`,L=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var R=`openpbrDirectLightingInit`,z=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[R]||(t.IncludesShadersStoreWGSL[R]=z);var B=`openpbrDirectLighting`,V=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStoreWGSL[B]||(t.IncludesShadersStoreWGSL[B]=V);var H=e({openpbrPixelShaderWGSL:()=>G}),U=`openpbrPixelShader`,W=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[U]||(t.ShadersStoreWGSL[U]=W);var G={name:U,shader:W};export{H as t};